...
分類 (英語 enum / 日本語ラベル):
    ...
    maintenance / 軽微作業     … 異常を伴わない作業・対応 (交換・メンテ・改修・是正 等。
                                  「回収」は 2026-08-25 改訂で failure へ移動、ここには含めない)
...
# 2026-09-07: 「バッテリー消耗」を追加。entry4 (故障率メトリクス、vero) の実データ検証で、
# バッテリー消耗が明確な機器の不具合であるにもかかわらずキーワードに無く、故障として
# 拾えていないケースが見つかったため (DATALOOP task10、2026-09-04)。
_FAILURE_KEYWORDS = [
    "不具合", "故障", "破損", "落下", "異常", "不良",
